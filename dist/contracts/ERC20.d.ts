...
export declare type MintFinishedEvent = {};
export declare type PauseEvent = {};
export declare type UnpauseEvent = {};
export declare type BurnEvent = {
    burner: Address;
    value: string;
};
...
export declare class ERC20 extends Contract<ERC20Definition> {
    constructor(eth: Eth, address?: Address, options?: ContractOptions);
}
export declare var ERC20Abi: import("web3x/contract").ContractAbi;
export {};
