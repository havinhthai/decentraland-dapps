...
export declare type ApprovalForAllEvent = {
    _owner: Address;
    _operator: Address;
    _approved: boolean;
};
...
export declare class ERC721 extends Contract<ERC721Definition> {
    constructor(eth: Eth, address?: Address, options?: ContractOptions);
}
export declare var ERC721Abi: import("web3x/contract").ContractAbi;
export {};
